...
from ...models import TransportRoute, EmissionFactor
from ...data import TRANSPORT_ROUTE_DATA_DIR

SOURCE_DIR = TRANSPORT_ROUTE_DATA_DIR # e.g. settings.DATA_DIR_INTERVENTION

MODEL_0 = TransportRoute
