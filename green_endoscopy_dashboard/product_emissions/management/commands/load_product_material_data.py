...
from ...models import ProductMaterial, Material, Product
from ...data import PRODUCT_MATERIAL_DATA_DIR

SOURCE_DIR = PRODUCT_MATERIAL_DATA_DIR # e.g. settings.DATA_DIR_INTERVENTION

MODEL_0 = ProductMaterial
