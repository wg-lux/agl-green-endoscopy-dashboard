...
from ...models import ProductWeight, Product
from ...data import PRODUCT_WEIGHT_DATA_DIR

SOURCE_DIR = PRODUCT_WEIGHT_DATA_DIR # e.g. settings.DATA_DIR_INTERVENTION

MODEL_0 = ProductWeight
